...
TBlendCopy TBlendModes::Copy;
TBlendWiki TBlendModes::HighPrecision;
TBlendGeneric< TBlendOpNormal > TBlendModes::Normal;
/*class TBlendNormal2: public TBlendOperation
{
public:
...
// TODO: eliminate these possibly copyrighted stuff?
